...
Fixpoint nodes_absnodes_match (nodes:list(val*vallist)) (absnodes:list(tid*(priority*taskstatus))) (rtbl:vallist) : Prop :=
...
Fixpoint set_abstcb (absnodes:list(tid*(priority*taskstatus))) (tcbls:TcbMod.map) : TcbMod.map :=
  match absnodes with
    | nil => tcbls
    | (tid,abstcb)::absnodes' =>
