...
Proof.
  ...
  lia.
  rewrite H4.
  erewrite <- Z.shiftr_spec_aux ; try lia.
  erewrite <- Z.shiftr_spec_aux ; try lia.
  ...
  rewrite  twopow_sub_1_testbit_true in fff; try lia.
...
(*  assert (y' <> $ 0).
  ...
  assert (0=Int.unsigned x1) by lia.
  rewrite H0.
