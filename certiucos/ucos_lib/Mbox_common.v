...
Proof.
  ...
  simpl in H0.
  mytac.
  rename H3 into Hprtb; rename H4 into H3. (* new add *)
  destruct a.
  destruct p. (* new add *)
  mytac.
  lets Hxs : IHl1 H1 H5.
...
Lemma ecblist_ecbmod_get_aux_mbox :
  forall v'61 i6  x4 x8 v'58 v'42  
         v'63 x20 v'37 v'35 v'36 v'38 petbl pegrp petbl_addr ,
...
Proof.
  ...
  auto.
  simpl in Hep.
  destruct Hep as (qid & Heq & Heb & Hpeb & Hex). (* add Hpeb *)
...
Lemma ecblist_ecbmod_get_mbox :
  forall v'61 i6  x4 x8 v'58 v'42 v'21 v'63 x20 v'37 v'35 v'36 v'38 petbl pegrp petbl_addr,
    length v'21 = O  ->
    array_type_vallist_match Int8u v'58->
    RH_CurTCB v'38 v'36 ->
    length v'58 = ∘OS_EVENT_TBL_SIZE ->
...
Lemma ecblist_ecbmod_get_mbox' :
  forall v'40 v'52 v'61 i6  x4 x8 v'58 v'42 v'21 xx
         v'63 x20 i5 v'37 v'35 v'36 v'38 petbl pegrp petbl_addr,
  ...
  auto.
  simpl in H0.
  destruct H0 as (qid & Heq & Heb & Hpeb & Hex). (* add Hpeb *)
  destruct Hex as (absmq & mqls' & v' & Hv & Hej & Hmt & Hlp).
  destruct absmq.
  destruct e; tryfalse.
  usimpl Hv.
...
Lemma R_ECB_PETbl_upd_hold :
  forall x1 v v0 v'36 x8 petbl,
    R_ECB_PETbl_P x1 (v, v0, petbl) v'36 ->
    R_ECB_PETbl_P x1 (ifun_spec.update_nth val 5 v x8, v0, petbl) v'36.
Proof.
  introv Hr.
  unfolds in Hr.
  destruct Hr.
...
(* ** ac:   Check R_ECB_upd_hold. *)
  ...
  simpl.
  simpl in Hep.
  destruct Hep as (qid & Heq & Hr & Hpb & Hex). (* add Hpb *)
...
Lemma RH_TCBList_ECBList_MUTEX_OWNER_P_subset_hold 
: forall x y z t, 
 RH_TCBList_ECBList_MUTEX_OWNER_P z t ->
 EcbMod.join x y z ->
 RH_TCBList_ECBList_MUTEX_OWNER_P x t.
Proof.
  intros.
  funfold H.
  unfolds.
  splits; intros;
  [ eapply H | eapply H1 | eapply H2 (* | eapply H3 *) ]; eauto;
...
Proof.
  ...
  eauto.
  2:{ intros.
         eapply Hpostq2 in H1.
         mytac.
         assert (Hc: eid = y \/ eid <>y) by tauto.
         destruct Hc. subst.
         ...
         destruct Hnil. subst; simpl in H2; tryfalse.
         false.
         eapply Hneq; eauto.
...
Lemma R_ECB_ETbl_P_high_ecb_mbox_acpt_hold :
  forall x2 i i1 a  x3 v'42 v'40 v'35 petbl pegrp petbl_addr,
 R_ECB_ETbl_P x2
          (V$OS_EVENT_TYPE_MBOX
           :: Vint32 i :: Vint32 i1 :: Vptr a :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil, v'40, petbl) v'35
->
 R_ECB_ETbl_P x2
     (V$OS_EVENT_TYPE_MBOX
      :: Vint32 i :: Vint32 i1 :: Vnull :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil, v'40, petbl) v'35
.
  intros.
  splits.
  unfolds in H.
...
Lemma R_ECB_PETbl_P_high_ecb_mbox_acpt_hold :
  forall x2 i i1 a  x3 v'42 v'40 v'35 petbl pegrp petbl_addr,
 R_ECB_PETbl_P x2
          (V$OS_EVENT_TYPE_MBOX
           :: Vint32 i :: Vint32 i1 :: Vptr a :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil, v'40, petbl) v'35
...
Lemma mbox_acpt_rh_tcblist_ecblist_p_hold:
 forall v'34 v'35 v'37 v w m,
 EcbMod.get v'34 v = Some (absmbox m, w) ->
...
Proof.
  ...
  unfolds.
  mytac; [clear -H H0| 
                   clear -H H1; rename H1 into H0|
                   clear -H H2; rename H2 into H0|
                   clear -H H3; rename H3 into H0];
                        ...
                        destruct aa;
                         [subst; rewrite EcbMod.set_a_get_a in e;
                            ...
                            rewrite EcbMod.set_a_get_a' in e;
                                      [eauto|apply tidspec.neq_beq_false];
                           auto]]
  ;
  try solve[
         lets aaa : H1 H2;
  ...
  elim H5; intros. (* change H4 -> H5 *)
  apply H1 in H4. (* change H3 -> H4 *)
  simpljoin.
  rewrite H4 in H. (* change H3 -> H4 *)
  inversion H.
  rewrite EcbMod.set_a_get_a' .
  eapply H1; eauto.
  go.
  ...
  Unfocus.
{
  ...
  rewrite EcbMod.set_sem in Ha.
  rewrite tidspec.neq_beq_false in Ha; auto.
  assert ( EcbMod.get ecbls eid =Some (absmsgq x y pqwaitset, qwaitset)/\ In tid qwaitset).
  splits; auto.
  apply Hr3 in H.
  mytac.
  assert (tid = pcur \/ tid <> pcur) by tauto.
  ...
  rewrite EcbMod.set_sem in Ha.
  rewrite tidspec.neq_beq_false in Ha; auto.
  assert ( EcbMod.get ecbls eid =Some (absmsgq x y pqwaitset, qwaitset)/\ In tid pqwaitset).
  splits; auto.
  apply Hr3 in H.
  mytac.
  assert (tid = pcur \/ tid <> pcur) by tauto.
...
Lemma  ecb_petbl_set_hold:
  forall x y tcbls prio st m ptcb m',
    TcbMod.get tcbls ptcb = Some (prio, st, m) ->
    R_ECB_PETbl_P x y tcbls  ->
    R_ECB_PETbl_P x y  (TcbMod.set tcbls ptcb (prio, st, m')).
Proof.
  introv Htc Hr.
  unfolds in Hr.
...
Proof.
  ...
  eapply ecb_petbl_set_hold; eauto. (* new add *)
  do 3 eexists; splits; eauto.
Qed.
...
Lemma TCBList_P_tcb_get_msg_hold :
    ...
    TcbMod.get tcbls ptcb = Some (prio, st, m) ->
    TCBList_P (Vptr ptcb) ((v1::v2::v3::m'::v5::v6::v7::v8::v9::v10::v11:: nil)::vl) rtbl 
                          (TcbMod.set tcbls ptcb (prio, st, m')).
Proof.
  introv Htc Hget.
  unfolds in Htc.
 ...
 intros.
  ...
  unfold  V_OSTCBEventPtr in H8.
  simpl in H8; eauto.
  assert ( exists m0, (prio, st, m) = (prio0, wait (os_stat_postq eid) t, m0)).
  eapply H8; eauto.
  mytac.
  eexists; eauto.
   (* end of new add *)
...
Lemma R_ECB_ETbl_P_high_tcb_block_hold:
  forall (l : addrval) (vl : vallist) (egrp : int32) 
    ...
    (m m' : msg) (y bity bitx ey time : int32) (av : addrval) petbl pegrp petbl_addr,
  Int.unsigned prio < 64 ->
  R_PrioTbl_P vl tcbls av ->
  R_ECB_ETbl_P l
    (V$OS_EVENT_TYPE_MBOX :: Vint32 egrp :: v2 :: v3 :: v4 :: v5 :: Vint32 pegrp :: petbl_addr :: nil, etbl,petbl)
    tcbls ->
  TcbMod.get tcbls ptcb = Some (prio, st, m) ->
  y = Int.shru prio ($ 3) ->
  bity = Int.shl ($ 1) y ->
...
Lemma R_ECB_PETbl_P_high_tcb_block_hold:
  forall  l tp egrp v2 v3 v4 v5 etbl petbl pegrp petbl_addr 
                 egrp' v2' v3' v4' v5' etbl' petbl' pegrp' petbl_addr' tcbls prio st ptcb m',
  ~(tp = Int.repr OS_EVENT_TYPE_Q) ->
  R_ECB_PETbl_P l
    (Vint32 tp :: Vint32 egrp :: v2 :: v3 :: v4 :: v5 :: Vint32 pegrp :: petbl_addr :: nil, etbl,petbl)
    tcbls ->
  ~(exists qid time, st = wait (os_stat_postq qid) time) ->
  R_ECB_PETbl_P l
    (Vint32 tp
     :: Vint32 egrp' :: v2' :: v3' :: v4' :: v5' :: Vint32 pegrp' :: petbl_addr' :: nil,
    etbl', petbl')
    (TcbMod.set tcbls ptcb (prio, st, m'))
.
Proof.
...
: forall (p : int32) (etbl : vallist) (ptbl : list val) 
    ...
    R_ECB_ETbl_P qid (V$OS_EVENT_TYPE_MBOX :: vle, etbl,petbl) tcbls ->
...
: forall (p : val) (qid : addrval) (mqls : EcbMod.map)
         ...
         (mqls' : EcbMod.map) (tcbls : TcbMod.map) petbl pegrp petbl_addr,
    R_ECB_ETbl_P qid
                 (V$OS_EVENT_TYPE_MBOX
                   :: Vint32 i :: Vint32 i1 ::  a :: x3 :: p' :: Vint32 pegrp :: petbl_addr :: nil, v'41, petbl) tcbls ->
    R_ECB_PETbl_P qid
                 (V$OS_EVENT_TYPE_MBOX
                   :: Vint32 i :: Vint32 i1 ::  a :: x3 :: p' :: Vint32 pegrp :: petbl_addr :: nil, v'41, petbl) tcbls -> (* new add *)
    ...
    ECBList_P p Vnull
              (qptrl1 ++
                      ((V$OS_EVENT_TYPE_MBOX
                         :: Vint32 i :: Vint32 i1 ::  a :: x3 :: p' :: Vint32 pegrp :: petbl_addr :: nil, v'41, petbl)
...
(* new add *)
Lemma R_ECB_PETbl_P_set_tcb_rdy_hold:
forall tcbls ptcb prio m st m' x v0 v1 v,
~(exists qid time, st = wait (os_stat_postq qid) time) ->
TcbMod.get tcbls ptcb = Some (prio, st, m) ->
R_ECB_PETbl_P x (v0, v1, v) tcbls ->
R_ECB_PETbl_P x (v0, v1, v)
  (TcbMod.set tcbls ptcb (prio, rdy, m')).
Proof.
intros.
funfold H1.
unfolds; splits; unfolds; intros.
...
: forall (v'36 : vallist) (v'12 : int32) (v'13 : vallist)
         ...
         (msg0 : msg) (y : int32) (vhold : addrval) petbl pegrp petbl_addr,
    (* RL_RTbl_PrioTbl_P v'13 v'36 vhold -> *)
    True ->
    v'12 <> Int.zero ->
    Int.unsigned v'12 <= 255 ->
...
Proof.
  ...
  mytac.
  assert (tid = tid0 \/ tid <> tid0) by tauto.
  destruct H11;subst. (* change H9 -> H11 *)
  unfold get in *; simpl in *.
  rewrite H3 in H8;tryfalse.
  do 3 eexists.
  rewrite TcbMod.set_sem.
  ...
  mytac.
  assert (eid = eid0 \/ eid <> eid0) by tauto.
  destruct H10;subst. (* change H8 -> H10 *)
  apply ecbmod_joinsig_get in H1.
  lets Hget : EcbMod.join_get_get_r H0 H1.
  unfold get in *; simpl in *.
  rewrite H4 in Hget;tryfalse.
...
Lemma AOSTCBPrioTbl_high_tcblist_get_msg :
  forall tcbls p prio st m vl rtbl m' s P av ptls,
    TcbMod.get tcbls p = Some (prio, st, m) ->
    s|= AOSTCBPrioTbl vl rtbl tcbls ptls av ** P ->
    s|= AOSTCBPrioTbl vl rtbl (TcbMod.set tcbls p (prio, st, m')) ptls av ** P.
Proof.
  introv Htcb Hs.
