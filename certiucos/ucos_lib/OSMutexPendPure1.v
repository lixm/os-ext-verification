...
Proof.
  ...
  simpl_vqm.
  eexists;eauto.
  unfolds in H5;simpl in H5;inverts H5. (* new add *)
...
Lemma R_ECB_ETbl_P_high_tcb_block_hold_mutex:
  forall (l : addrval) (vl : vallist) (egrp : int32) 
    ...
    R_ECB_ETbl_P l
                 (V$OS_EVENT_TYPE_MUTEX :: Vint32 egrp :: v2 :: v3 :: v4 :: v5 :: Vint32 pegrp :: petbl_addr :: nil,
                  etbl, petbl) tcbls ->
...
Lemma R_ECB_ETbl_P_high_tcb_block_hold:
  forall (l : addrval) (vl : vallist) (egrp : int32) 
    ...
    R_PrioTbl_P vl tcbls av ->
    R_ECB_ETbl_P l
                 (V$OS_EVENT_TYPE_MUTEX :: Vint32 egrp :: v2 :: v3 :: v4 :: v5 :: Vint32 pegrp :: petbl_addr :: nil, etbl, petbl)
                 tcbls ->
    TcbMod.get tcbls ptcb = Some (prio, st, m) ->
    y = prio>>ᵢ$ 3 ->
    bity = $ 1<<ᵢy ->
  ...
  forall v'57 v'69 v'38 v'46 x ptcb_addr wls x3 v'48 v'28 v'30 v'40 tcbls v'44 v'27 v'29 cur_prio v'66 v'65 v'68 v'64 i os_rdy_tbl x0 v'26 x12 i5 ptbl vhold
    ...
    ECBList_P v'44 Vnull
              (v'27 ++
                    ((V$OS_EVENT_TYPE_MUTEX
                       :: Vint32 v'69
                       :: Vint32 x :: Vptr (ptcb_addr, Int.zero) :: x3 :: v'48 :: Vint32 pegrp :: petbl_addr :: nil,
                      v'57, petbl) :: nil) ++ v'28)
              (v'29 ++
    ...
    ECBList_P v'44 Vnull
              (v'27 ++
                    ((V$OS_EVENT_TYPE_MUTEX
                       ...
                       :: Vint32 x :: Vptr (ptcb_addr, Int.zero) :: x3 :: v'48 :: Vint32 pegrp :: petbl_addr :: nil,
                      update_nth_val ∘(Int.unsigned v'64) v'57 (Vint32 (Int.or v'68 v'65)), petbl)
                       :: nil) ++ v'28)
...
Proof.
  ...
  assert ((e,w) = (absmutexsem (x>>ᵢ$ 8)
                               (Some (ptcb_addr, Int.zero, x&ᵢ$ OS_MUTEX_KEEP_LOWER_8)), wls)).
  {
    clear - H13 H8 H4. (* change H12 -> H13 *)
    apply ecbmod_joinsig_get in H13. (* change H12 -> H13 *)
    eapply EcbMod.join_get_r in H13;eauto. (* change H12 -> H13 *)
    rewrite H13 in H4;inverts H4;auto. (* change H12 -> H13 *)
  }
  ...
  clear H5.
  unfolds in H12;inverts H12. (* change H11 -> H12 *)
  ...
  auto.
  (* new add about petbl *)
  eapply Mbox_common.R_ECB_PETbl_P_high_tcb_block_hold; eauto.
  introv Hf. destruct Hf as (qd & wt & Hf). inverts Hf.
  (* end of new add *)
