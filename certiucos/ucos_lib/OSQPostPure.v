...
Lemma ecbmod_absmsgq:
  forall a x y z b,
    RLH_ECBData_P
      (DMsgQ a x y z) b -> exists vl n pwl wl, b = (absmsgq vl n pwl, wl).
Proof.
  intros.
...
Lemma post_exwt_succ_pre:
  forall v'36 v'13 v'12 v'32 v'15 v'24 v'35 v'0 v'8 v'9 v'11 x x0 x1 v'6 v'10 v'38 v'69 v'39 v'58 a b c v'62 v'7 vhold
    ...
    EcbMod.joinsig (v'32, Int.zero) (absmsgq x x0 pwl, x1) v'6 v'10 ->
...
Proof.
  ...
  destruct H3 as (Heg1 & Heg3 & Heg2 & Heg4).
(*   destruct H3 as (Heg1 & Heg2). *)
  lets Hrgs : Heg2 Hs.
  destruct Hrgs as (xz & y & pqw & qw & Hem & Hin).
  ...
  intros.
  assert (EcbMod.get v'11 (v'32, Int.zero) = Some (absmsgq xz y pqw, qw) /\ In t' qw) .
  splits; auto.
  lets Habs : Heg1 H22.
...
Lemma RLH_WaitPostQ_P_rtbl_add:
  forall prio0 prio rtbl grp stat msg vl,
    0 <= Int.unsigned prio0 < 64 ->
    0 <= Int.unsigned prio < 64 ->
    prio0 <> prio ->
    V_OSTCBPrio vl = Some (Vint32 prio0) ->
    nth_val ∘(Int.unsigned (Int.shru prio ($ 3))) rtbl = Some (Vint32 grp) ->
    RLH_WaitPostQ_P vl rtbl (prio0, stat, msg) ->
    RLH_WaitPostQ_P vl 
                (update_nth_val (Z.to_nat (Int.unsigned (Int.shru prio ($ 3)))) rtbl
                                (Vint32 (Int.or grp ($ 1<<ᵢ(prio&ᵢ$ 7)))))
                (prio0, stat, msg).
...
Proof.
  ...
  eapply RLH_WaitPostQ_P_rtbl_add; eauto. (* new add *)
Qed.
...
Lemma RHL_WaitPostQ_P_rtbl_add:
  forall prio0 prio rtbl grp stat msg vl,
    0 <= Int.unsigned prio0 < 64 ->
    0 <= Int.unsigned prio < 64 ->
    prio0 <> prio ->
    V_OSTCBPrio vl = Some (Vint32 prio0) ->
    nth_val ∘(Int.unsigned (Int.shru prio ($ 3))) rtbl = Some (Vint32 grp) ->
    RHL_WaitPostQ_P vl rtbl (prio0, stat, msg) ->
    RHL_WaitPostQ_P vl 
                (update_nth_val (Z.to_nat (Int.unsigned (Int.shru prio ($ 3)))) rtbl
                                (Vint32 (Int.or grp ($ 1<<ᵢ(prio&ᵢ$ 7)))))
                (prio0, stat, msg).
...
Proof.
  ...
  eapply RHL_WaitPostQ_P_rtbl_add; eauto. (* new add *)
Qed.
...
Lemma wtset_notnil_msgls_nil:
  forall x1 x0 x x2,
  x1 <> nil ->
  RH_ECB_P (absmsgq x x0 x2, x1) -> x = nil.
Proof.
  intros.
  unfolds in H0.
  eapply H0; eauto.
...
Lemma ecblist_p_post_exwt_hold:
  forall  v'36 v'12 v'13 v'38 v'69 v'39 v'58 v'40  v'32 v'15 v'24 v'35 v'16
          v'18 v'19 v'20 v'34 v'21 v'22 v'23 v'25 v'26 v'27 x x0 x1 v'0 v'1 x2 (* add x2 *)
    ...
    RLH_ECBData_P
      (DMsgQ (Vptr (v'24, Int.zero))
             ...
             (v'26 :: v'25 :: nil) v'27) (absmsgq x x0 x2, x1)->
    ECBList_P v'0 Vnull v'1 v'5 v'6 v'7 ->
    ECBList_P v'29 (Vptr (v'32, Int.zero)) v'30 v'31 v'9 v'7 ->
    EcbMod.joinsig (v'32, Int.zero) (absmsgq x x0 x2, x1) v'6 v'10 ->
    EcbMod.join v'9 v'10 v'11 ->
    TcbJoin (v'58, Int.zero) (prio, st, msg) v'62 v'7 ->
    R_PrioTbl_P v'36 v'7 vhold ->
    x1 <> nil ->
    ECBList_P v'29 Vnull
              ...
              (EcbMod.set v'11 (v'32, Int.zero)
                          (absmsgq nil x0 x2, remove_tid (v'58, Int.zero) x1))
...
Lemma rh_tcblist_ecblist_p_post_exwt:
  forall v'8 tid v'11 v'7 v'9 v'10 eid x x0 x1 v'6 prio  msg v'00 xl pwl,
    RH_TCBList_ECBList_P v'11 v'7 v'8 ->
    EcbMod.join v'9 v'10 v'11 ->
    EcbMod.joinsig eid (absmsgq x x0 pwl, x1) v'6 v'10 ->
    In tid x1 ->
    TcbMod.get v'7 tid = Some (prio,  wait (os_stat_q eid) xl, msg) ->
    RH_TCBList_ECBList_P
      (EcbMod.set v'11 eid
                  (absmsgq nil x0 pwl, remove_tid tid x1))
      (TcbMod.set v'7 tid
                  (prio, rdy , v'00)) v'8.
Proof.
  intros.
  ...
  assert (EcbMod.get v'11 eid = Some (absmsgq x x0 pwl, x1)/\ In tid0 x1 ).
  splits; auto.
  lets Hsa : H H7.
  simpljoin1.
  ...
  apply ecbmod_joinsig_get in H1.
  lets Hget : EcbMod.join_get_get_r H0 H1.
  assert ( EcbMod.get v'11 eid0 = Some (absmsgq x y pqwaitset, x1) /\ In tid0 x1 ).
  splits; auto.
  apply H in H4.
  simpljoin1.
  do 3 eexists; eauto.
  ...
  assert (get (EcbMod.set v'11 eid (absmsgq nil x0 pwl, remove_tid tid0 x1)) eid = Some (absmsgq nil x0 pwl, remove_tid tid0 x1) ).
  eapply map_tactics.get_set_eq.
  assert (eid = eid0 \/ eid <> eid0) by tauto.
  destruct H8.
  (* eid = eid0*)
  subst.
  unfold get in H4,H7;simpl in H4,H7.
  rewrite H4 in H7.
  assert (pqwaitset = pwl).
  inverts H7. auto.
  assert (EcbMod.get v'11 eid0 = Some (absmsgq x x0 pwl, x1)/\ In tid0 pwl ).
  splits. auto. rewrite H8 in H5. auto.
  lets Hsa : H' H9.
  simpljoin1.
  ...
  rewrite EcbMod.set_sem in H4.
  rewrite tidspec.neq_beq_false in H4; auto.
  assert (EcbMod.get v'11 eid0 = Some (absmsgq x2 y pqwaitset, qwaitset) /\ In tid0 pqwaitset ).
  splits;auto.
  lets Hsc : H' H9.
  simpljoin1.
  unfold get in H10;simpl in H10.
  rewrite H3 in H10. inverts H10.
  (*tid <> tid0*)
  rewrite TcbMod.set_sem .
  rewrite tidspec.neq_beq_false; auto.
  assert (eid = eid0 \/ eid <> eid0) by tauto.
  ...
  rewrite tidspec.eq_beq_true in H4; auto.
  inverts H4.
  lets Hbss :tidneq_inwt_in  pqwaitset H7.
  destruct Hbss as (Hbss & _).
  (* lets Hbssc : Hbss H5. *)
  apply ecbmod_joinsig_get in H1.
  lets Hget : EcbMod.join_get_get_r H0 H1.
  assert ( EcbMod.get v'11 eid0 = Some (absmsgq x y pqwaitset, x1) /\ In tid0 pqwaitset ).
  splits; auto.
  apply H' in H4.
  simpljoin1.
  do 3 eexists; eauto.
...
(*   lets Hbssc : Hbss H7. *)
  ...
  simpljoin1.
  assert (tid = tid0 \/ tid <> tid0) by tauto.
  destruct H11;subst. (* change H10 -> H11 *)
  unfold get in H8; simpl in H8.
  rewrite H3 in H8;tryfalse.
  do 3 eexists.
  rewrite TcbMod.set_sem.
  ...
  simpljoin1.
  assert (eid = eid0 \/ eid <> eid0) by tauto.
  destruct H10;subst. (* change H9 -> H10 *)
  apply ecbmod_joinsig_get in H1.
  lets Hget : EcbMod.join_get_get_r H0 H1.
  unfold get in H4; simpl in H4.
  rewrite H4 in Hget;tryfalse.
  ...
  (* new add *)
  destruct H4 as (H4 & Howp).
  eapply H4 in H5.
  destruct H5.
  split.
  do 3 eexists;eauto. (* old *)
  auto. (* new add *)
  apply CltEnvMod.beq_refl.
  rewrite TcbMod.set_a_get_a'.
  2:apply tidspec.neq_beq_false; auto.
    ...
    RLH_ECBData_P
      (DMsgQ (Vptr (v'47, Int.zero))
             (x13
                ...
                :: Vint32 i2
                :: Vint32 i1 :: Vptr (v'49, Int.zero) :: nil)
             (x14 :: x15 :: nil) v2)  (absmsgq x x1 pwl, x2) ->
...
Proof.
  introv Hwl.
  funfold Hwl.
  rename x9 into qens; rename H12 into Hqensltsize; rename H13 into H11. (* new add *)
  unfold qend_right, arrayelem_addr_right in *.
  simpljoin1.
  unfold ptr_offset_right, ptr_minus in *.
  destruct x1.
...
Proof.
  ...
  remember ( Int.unsigned (Int.divu (i-ᵢ$ 4) ($ 4))) as N.
  assert (M = N \/ M > N \/ M < N).
  clear -x.
  lia.
...
Lemma rlh_ecb_nowait_prop:
  forall v'25 i i3 v'47 x4 v'42 v'40 v'35 v'34 x1 x2 x3 v'37 v'41 pwl,
...
Proof.
  introv Hlt Hle Hvl Hj.
  funfold Hvl.
  rename x9 into qents; rename H12 into Hqensltsize; rename H13 into H11. (* new add *)
  unfold qend_right, arrayelem_addr_right in *.
  simpljoin1.
  unfold ptr_offset_right, ptr_minus in *.
  destruct x1.
  ...
  simpl in *.
  (* change *)
  unfold WellformedOSQ.
  do 8 eexists; splits; try solve [unfolds; simpl; eauto].
  instantiate (1:=(qents +ᵢ  $ 1)).
  (* end of change *)
...
: forall (p : val) (qid : addrval) (mqls : EcbMod.map)
         ...
         (a : addrval) (x3 p' : val) (v'41 : vallist) (v'42 : vallist)
         (msgqls1 msgqls2 : list EventData) (msgq : EventData)
         (mqls1 mqls2 : EcbMod.map) (mq : absecb.B) 
         (mqls' : EcbMod.map) (tcbls : TcbMod.map) i0 x6,
    R_ECB_ETbl_P qid
                 ((V$OS_EVENT_TYPE_Q
                   :: Vint32 i :: Vint32 i1 :: Vptr a :: x3 :: p' ::  Vint32 i0 :: x6  :: nil, v'41),v'42) tcbls ->
    R_ECB_PETbl_P qid
                ( (V$OS_EVENT_TYPE_Q
                   :: Vint32 i :: Vint32 i1 :: Vptr a :: x3 :: p' :: Vint32 i0 :: x6  :: nil, v'41),v'42) tcbls -> (* new add *)
    ...
    ECBList_P p Vnull
              (qptrl1 ++
                      (((V$OS_EVENT_TYPE_Q
                         :: Vint32 i :: Vint32 i1 :: Vptr a :: x3 :: p' :: Vint32 i0 :: x6  :: nil, v'41),v'42)
...
Lemma rlh_ecbdata_in_end:
  forall i1 i2 x13 x12 v'49 x x8 v'47 x14 x15 v2 x1 x2 x0 pwl,
    Int.ltu i1 i2 = true ->
    length v2 = ∘OS_MAX_Q_SIZE ->
    WellformedOSQ
      (x13
    ...
    RLH_ECBData_P
      (DMsgQ (Vptr (v'47, Int.zero))
             (x13
                ...
                :: Vint32 i2
                :: Vint32 i1 :: Vptr (v'49, Int.zero) :: nil)
             (x14 :: x15 :: nil) v2) (absmsgq x1 x2 pwl, nil) ->
    RLH_ECBData_P
      (DMsgQ (Vptr (v'47, Int.zero))
             (x13
                :: x12
             ...
             (update_nth_val
                (Z.to_nat
                   ((Int.unsigned x - Int.unsigned (Int.zero+ᵢ($ 4+ᵢInt.zero))) /
                                                                                4)) v2 (Vptr x0))) (absmsgq (x1 ++ (Vptr x0::nil)) x2 pwl, nil).
Proof.
  introv Hi Hlen Hw Hr.
  funfold Hw.
  rename x11 into qents; rename H12 into Hqensltsize; rename H13 into H11. (* new add *)
  unfold qend_right, arrayelem_addr_right in *.
  unfold ptr_offset_right,   ptr_minus  in *.
  fsimpl.
  simpl in H7.
  ...
  (* new add *)
  lets Hcp : Hi.
  rewrite Intlt_true_is_Zlt in Hcp. 
  rewrite H7 in Hcp.
  assert (Hneq: length x1 <> Z.to_nat (Int.unsigned x2)).
  {
  eapply Z2Nat.id in H14.
  rewrite <- H14 in Hcp.
  rewrite <- Nat2Z.inj_lt in Hcp.
  pure_auto.
  rewrite <- H5 in Hcp.
  clear -Hcp.
  induction x1; simpl in *; auto with zarith.
  }
  (* new add *)
  ...
  rewrite H9 in *.
  rewrite H16 in *.
  lets Heq : math_le_xyz  H11 H0 H12 H H3; eauto.
  rewrite Int.repr_unsigned; auto.
  rewrite H16 in *.
  destruct Heq as (Hle & Hse & He).    
  assert ( Int.unsigned (Int.divu (x-ᵢ$ 4) ($ 4)) >  Int.unsigned (Int.divu (i-ᵢ$ 4) ($ 4)) \/
           Int.unsigned (Int.divu (x-ᵢ$ 4) ($ 4)) =  Int.unsigned (Int.divu (i-ᵢ$ 4) ($ 4))) by lia.
  destruct H5 as [Ha1 | Ha2].
  lets Hres : H18 Ha1.
  ...
  splits.
  intros.
  assert (0<=Int.unsigned (Int.divu (i-ᵢ$ 4) ($ 4))).
  apply Int.unsigned_range.
  lia.
  intros.
  rewrite <- Hse.
  lets Heqs : math_le_max_q H11 H2 Hse.
  ...
  rewrite <- Hse.
  rewrite Has.
  lets Hcs : math_len_le_and (Vptr x0) Hlen H11 H2 Hse.
  ...
  unfolds.
  (* new add *)
  unfold RH_ECB_P in Hm4.
  destruct Hm4 as (Hm41 & Hm42 & Hm43 & Hm44).
  eapply Hm43 in Hneq.
  subst pwl.
  splits; auto;
  intros;
...
Lemma rh_tcbls_mqls_p_setmsg_hold:
  forall (mqls : EcbMod.map) (tcbls : TcbMod.map) (ct : tid) 
         ...
         (wl : waitset) (pwl : list tid),
    RH_TCBList_ECBList_P mqls tcbls ct ->
    EcbMod.get mqls a = Some (absmsgq vl qmax pwl, wl) ->
    RH_TCBList_ECBList_P (EcbMod.set mqls a (absmsgq (vl++v::nil) qmax pwl, wl)) tcbls ct.
Proof.
  intros.
...
(*   clear H1; intros. *)
  ...
  rewrite H in H0; inverts H0. do 4 eexists.
  eauto.
  rewrite EcbMod.set_a_get_a'; auto.
  eapply H2; eauto.
  ...
  destruct H5; intros. (*change H4 -> H5*)
  subst eid.
  rewrite EcbMod.set_a_get_a in H4. (* change H3 -> H4 *)
  inversion H4. (* change H3 -> H4 *)
  apply CltEnvMod.beq_refl.
  rewrite EcbMod.set_a_get_a' in H4. (* change H3 -> H4 *)
  2:apply tidspec.neq_beq_false; auto.
  eapply H2;eauto.
...
Proof.
  intros.
  rename H0 into Hlt; rename H1 into Hle; rename H2 into H0. (* new add *)
  assert (Int.mul ($ 1) ($ 4) = $ 4) by (clear Hle; mauto). (* change *)
  rewrite H1 in *.
  funfold H0.
  rename x9 into qens; rename H14 into Hqensltsize; rename H15 into H13. (* new add *)
  unfold qend_right, arrayelem_addr_right in *.
  simpljoin1.
  unfold ptr_offset_right, ptr_minus in *.
  fsimpl.
...
(*   do 7 eexists; splits; try solve [unfolds; simpl; eauto]. *)
  ...
  simpl.
  eapply math_lt_mod_lt with (* i2 *) i1 ;eauto.
  intro Hf.
  subst (* i2 *) i1.
  tryfalse.
  unfolds.
...
Lemma rlh_ecbdata_in_noend:
  forall i1 i2 x13 x12 v'49 x x8 v'47 x14 x15 v2 x1 x2 x0 x6 pwl,
    x6 <> Vptr (v'49, x+ᵢInt.mul ($ 1) ($ 4)) ->
    Int.ltu i1 i2 = true ->
    length v2 = ∘OS_MAX_Q_SIZE ->
    WellformedOSQ
...
Proof.
  ...
  funfold Hw.
  rename x16 into qens; rename H12 into Hqenslesize; rename H13 into H11. (* new add *)
  unfold qend_right, arrayelem_addr_right in *.
  unfold ptr_offset_right,   ptr_minus  in *.
  fsimpl.
  ...
  splits.
  introv Hc1.
  lets Heq :math_int_lt_eq_split H0 H HeqM HeqN  Hc1; eauto.
  ...
  tryfalse.
  introv Hc2.
  lets Heq :math_int_lt_eq_split' H0 H HeqM HeqN  Hc2; eauto.
  destruct Heq as (He1 & He2 & He3 & He4).
  rewrite He3.
  rewrite He1.
  lets Hres : H21 He2.
  ...
  apply He4.
  introv Hc3.
  lets Heq :math_int_lt_eq_split'' H0 H HeqM HeqN  Hc3; eauto.
  right.
  destruct Heq as (He1 & He2 & He3 & He4).
...
Lemma get_tcb_stat:
  forall p etbl petbl ptbl tid tcbls abstcb tcbls' vl rtbl qid vle vhold,
    0 <= Int.unsigned p < 64 ->
...
Lemma rh_tcblist_ecblist_p_post_exwt_aux:
  forall (v'8 tid0 : tid) (v'11 : EcbMod.map) 
         ...
         (x0 : maxlen) (x1 : waitset) (pwl : waitset) (v'6 : EcbMod.map) 
...
(**)    
    R_ECB_ETbl_P (v'32, Int.zero)
                 ((V$OS_EVENT_TYPE_Q
                   :: Vint32 v'12
                   :: Vint32 v'15 :: Vptr (v'24, Int.zero) :: v'35 :: v'0 :: Vint32 i0 :: x6 :: nil,
                  v'13),v'80) v'7 ->
    R_ECB_PETbl_P (v'32, Int.zero)
                ( (V$OS_EVENT_TYPE_Q
                   :: Vint32 v'12
                   :: Vint32 v'15 :: Vptr (v'24, Int.zero) :: v'35 :: v'0 :: Vint32 i0 :: x6 :: nil,
                  v'13),v'80) v'7 -> (* new add *)
    RLH_ECBData_P
      (DMsgQ (Vptr (v'24, Int.zero))
             (v'16
                :: v'18
                ...
                :: Vint32 v'21
                :: Vint32 v'22 :: Vptr (v'23, Int.zero) :: nil)
             (v'26 :: v'25 :: nil) v'27) (absmsgq x x0 pwl, x1) ->
    ECBList_P v'0 Vnull v'1 v'5 v'6 v'7 ->
    ECBList_P v'29 (Vptr (v'32, Int.zero)) v'30 v'31 v'9 v'7 ->
    EcbMod.joinsig (v'32, Int.zero) (absmsgq x x0 pwl, x1) v'6 v'10 ->
    EcbMod.join v'9 v'10 v'11 ->
    ...
    ECBList_P v'29 Vnull
              (v'30 ++
                    (((V$OS_EVENT_TYPE_Q
                       ...
                       :: Vint32 v'15 :: Vptr (v'24, Int.zero) :: v'35 :: v'0 :: Vint32 i0 :: x6 :: nil,
                      update_nth_val (Z.to_nat (Int.unsigned v'38)) v'13
                                     (Vint32 (v'69&ᵢInt.not v'40))),v'80) :: nil) ++ v'1)
              (v'31 ++
                    (DMsgQ (Vptr (v'24, Int.zero))
                           (v'16
                              :: v'18
                           ...
                           (v'26 :: v'25 :: nil) v'27 :: nil) ++ v'5)
              (EcbMod.set v'11 (v'32, Int.zero)
                          (absmsgq nil x0 pwl, remove_tid (v'58, Int.zero) x1))
              (TcbMod.set v'7 (v'58, Int.zero)
                          (prio, rdy , v'00))
.
Proof.
  intros.
  (* new add *)
  rename H14 into H13'. rename H15 into H14; rename H16 into H15; rename H17 into H16; rename H18 into H17;
  rename H19 into H18; rename H20 into H19; rename H21 into H20; rename H22 into H21.
  (* end of new add *)
  unfolds in H20.
  ...
  lets Hsds : ecb_set_join_join  (absmsgq nil x0 pwl, remove_tid tid x1)  H17  H18.
  destruct Hsds as ( vv & Hsj1 & Hsj2).
  eapply msgqlist_p_compose.
  instantiate (1:= (v'32, Int.zero)).
  unfolds.
  ...
  splits.
  unfolds.
  unfold R_ECB_PETbl_P in H13'. 
  destruct H13' as (Haa & Hbb).
  introv Hprs Hxx.
  clear Hxx.
  apply prio_wt_inq_convert in Hprs.
  destruct Hprs as (Hprs1 & Hprs2).
  rename Hprs1 into Hpq.
  rename Hprs2 into Hneq.
(*   destruct Hprs1 as (Hpq & Hneq). *)
  unfolds in Ha.
  lets Hxs : Haa Hpq.
  rewrite Int.repr_unsigned in Hxs.
  ...
  apply r in H21.
  subst x.
  instantiate (1:=(absmsgq nil x0 pwl, remove_tid tid x1)).
  splits; auto.
  unfolds.
   (* change *)
  destruct r as (r1 & r2 &r3 & r4).
  splits. intros; auto; tryfalse. intros. auto.
  apply r3. apply r4. 
  (* end of change *)
(*   splits; intros; auto; tryfalse. *)
  eapply Hsj1.
...
Lemma qpost_ovf_prop1 :
  forall (i2 i1 : int32) (x13 x12 x6 x7 x8 : val) 
         ...
         (x1 : maxlen) (x2 : waitset) (pwl : waitset) (v2 : vallist),
