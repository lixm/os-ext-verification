...
Proof.
  ...
  destruct l1.
  unfolds in H0; simpl in H0. destruct a.
...
Ltac solve_Afalse_in_pre :=
  ...
  [intros s_1 H_1; destruct s_1 as [[[[[[]]]]]]; simpl in H_1; simpljoin1; tryfalse |
   apply pfalse_rule].

Lemma struct_type_vallist_match_os_event :
  forall v,
    struct_type_vallist_match os_ucos_h.OS_EVENT v ->
    exists v1 v2 v3 v4 v5 v6 tail, v = v1 :: v2 :: v3 :: v4 :: v5 :: v6 :: tail.  
Proof.
  intros.
...
Lemma evsllseg_append1 :
  forall (v'9:list EventCtr) (v'11:list EventData) v'6 v'13 v'12 x4 (v1:val) x6 v'8 tail v'10 v0 v1 v'9 v'11 s d i0,
    ...
    struct_type_vallist_match os_ucos_h.OS_EVENT
      (i0 :: v'12 :: x4 :: v1 :: x6 :: v'8 :: tail) ->
    s |= evsllseg v'6 (Vptr (v'13, Int.zero)) v'9 v'11 **
      Astruct (v'13, Int.zero) os_ucos_h.OS_EVENT(i0 :: v'12 :: x4 :: v1 :: x6 :: v'8 :: tail) **
      AOSEventTbl v'10 v0 ** AEventData (i0 :: v'12 :: x4 :: v1 :: x6 :: v'8 :: tail) d ->
    s |= evsllseg v'6 v'8 (v'9 ++ (i0 :: v'12 :: x4 :: v1 :: x6 :: v'8 :: tail, v0) :: nil) (v'11 ++ d :: nil).
Proof.
  intros.
  gen v'6 v'13 v'12 x4 x6 v'8 tail v'10 v0 v2.
  gen v'1 s d i0.
  clear - v'0. 
...
Lemma upd_last_ectrls_last :
  forall l v1 v2 v3 v4 v5 v6 v7 etbl x,
...
Proof.
  ...
  simpl length.
  simpl.
  assert (p :: l ++ (v1 :: v2 :: v3 :: v4 :: v5 :: x :: v7, etbl) :: nil =
          (p :: l) ++ (v1 :: v2 :: v3 :: v4 :: v5 :: x :: v7, etbl) :: nil). 
