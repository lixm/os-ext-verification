...
Proof.
  ...
  auto.
  rewrite <- H1 in H.
  assert (Int.unsigned x0 < two_p 16 ) by lia.
...
Lemma  R_ECB_ETbl_P_high_ecb_mutex_acpt_hold :
  forall x9 i x x3 v'44 v'42 v'37 i6 v'50 petbl pegrp petbl_addr,
    R_ECB_ETbl_P x9
                 (V$OS_EVENT_TYPE_MUTEX
                   :: Vint32 i :: Vint32 x :: Vnull :: x3 :: v'44 :: Vint32 pegrp :: petbl_addr :: nil, v'42, petbl) v'37 ->
    R_ECB_ETbl_P x9
                 (V$OS_EVENT_TYPE_MUTEX
                   :: Vint32 i
                   :: Vint32 (Int.or (x&ᵢ$ OS_MUTEX_KEEP_UPPER_8) i6)
                   :: Vptr (v'50, Int.zero) :: x3 :: v'44 :: Vint32 pegrp :: petbl_addr :: nil, v'42,petbl) v'37.
Proof.
  intros.
  splits.
  unfolds in H.
...
(* new add *)
Lemma  R_ECB_PETbl_P_high_ecb_hold :
  forall x9 tp i x x2 x3 x4 etbl petbl pegrp petbl_addr v'37
                           i' x' x2' x3' x4' etbl' petbl' pegrp' petbl_addr',
    ~(tp = Int.repr OS_EVENT_TYPE_Q) ->
    R_ECB_PETbl_P x9
                 (Vint32 tp
                   :: Vint32 i :: Vint32 x :: x2 :: x3 :: x4 :: Vint32 pegrp :: petbl_addr :: nil, etbl, petbl) v'37 ->
    R_ECB_PETbl_P x9
                 (Vint32 tp
                   :: Vint32 i'  :: Vint32 x' :: x2' :: x3' :: x4' :: Vint32 pegrp' :: petbl_addr' :: nil, etbl',petbl') v'37.
Proof.
...
Proof fun x y => acpt_int_lemma00 x.
  ...
  Proof.
    intros.
    assert (Int.unsigned x <= 65279 \/ Int.unsigned x > 65279) by lia.
    elim H0; intros.
    Focus 2.
    assert ( 65279 < Int.unsigned x <= 65535) by lia.
    clear -H2.
    mauto.
    clear -H1.
    unfold Int.shru.
  ...
  Lemma eventtype_neq_mutex:
    forall v'38 v'21 i1 i0 i2 x2 x3 v'42 v'40 v'22 v'23 v'41 v'24 v'34 v'35 v'49 s P v'43 v'45 v'44 v'46 petbl pegrp petbl_addr,
      length v'21 = length v'23-> 
      ECBList_P v'38 Vnull
                (v'21 ++
                      ((Vint32 i1 :: Vint32 i0 :: Vint32 i2 :: x2 :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil,
                        v'40,petbl) :: nil) ++ v'22) (v'23 ++ (v'41 :: nil) ++ v'24) v'34 v'35 ->
      ...
      s|= AEventData
       (Vint32 i1 :: Vint32 i0 :: Vint32 i2 :: x2 :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil) v'41 ** P ->
      s |= AEventData
        (Vint32 i1 :: Vint32 i0 :: Vint32 i2 :: x2 :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil) v'41 **
  ...
  Proof.
    ...
    Unfocus.
    {
      ...
      simpljoin.
      inverts H6.
      lets Hx:EcbMod.join_joinsig_get H7 H11 (* H10 *).
      rewrite H17 (* H16 *) in Hx.
      tryfalse.
    }
    {
      sep auto.
...
Lemma RH_TL_EL_MUTEX_OWNER_hold: 
forall tls tid els eid prio st msg o1 pp w1 w2 pr, 
TcbMod.get tls tid = Some (prio, st, msg) -> 
~(In tid w2) -> (* new add *)
EcbMod.get els eid = Some (absmutexsem pr o1, w1) -> 
RH_TCBList_ECBList_MUTEX_OWNER els tls -> 
RH_TCBList_ECBList_MUTEX_OWNER (EcbMod.set els eid (absmutexsem pr (Some (tid, pp)), w2)) tls.
Proof.
  intros.
  unfold RH_TCBList_ECBList_MUTEX_OWNER in *.
  intros.
...
: forall (v'36 v'13 : vallist) (v'12 : int32) 
         ...
         (vhold : addrval) pr o a petbl pegrp petbl_addr,
    v'12 <> Int.zero ->
    ...
    R_ECB_ETbl_P (v'32, Int.zero)
                 (V$OS_EVENT_TYPE_MUTEX
                   :: Vint32 v'12
                   :: Vint32 v'15 :: Vptr (v'24, Int.zero) :: v'35 :: v'0 :: Vint32 pegrp :: petbl_addr :: nil,
                  v'13, petbl) v'7 ->
...
(* TODO no lia hoare_assign_struct' *)
...
Proof.
  ...
  assert ( x < length ls \/ x >= length ls)%nat as strange_name by lia.
  simpljoin.
...
Proof.
  ...
  apply nth_val'_imp_nth_val_vptr in H12.
    ...
    lets Hzzps :  math_nth_8_eq_zero'  H13   H28; eauto; try lia.
  ...
  Proof.
    ...
    unfold Int.shl.
    rewrite H.
    apply unsignedsimpllemma in H ; [subst | lia].
    repeat ur_rewriter.
    split; simpl; auto; try lia.
    simpl; int auto.
...
Proof.
  ...
  assert (EcbMod.get v'38 (v'59,Int.zero) =  Some (absmutexsem (v'55>>ᵢ$ 8)
                                                               (Some (v'52, $ 0, v'55&ᵢ$ OS_MUTEX_KEEP_LOWER_8)), w)  
                /\ In (v'52,Int.zero) w) by (split;auto).
  apply H8 in H12. (*  change H11 -> H12 *)
  simpljoin.
  unfold get in *; simpl in*.
  rewrite Htget in H12;inverts H12. (*  change H11 -> H12 *)
...
Proof.
  ...
  false.
  apply H0.
  assert (Int.unsigned x = Int.unsigned y) by lia.
  eapply unsigned_inj; eauto.
Qed.
...
Lemma return_r_ecb_et_p :
  forall  i  v'52 x3 v'46 v'44 v'39 v'29 x p m petbl pegrp petbl_addr,
    TcbMod.get v'39 (v'52, Int.zero) = Some (p,rdy,m) ->
    R_ECB_ETbl_P (v'29, Int.zero)
                 (V$OS_EVENT_TYPE_MUTEX
                   :: Vint32 i :: Vint32 x :: Vptr (v'52, $ 0) :: x3 :: v'46 :: Vint32 pegrp :: petbl_addr :: nil,
                  v'44, petbl) v'39 ->
    R_ECB_ETbl_P (v'29, Int.zero)
                 (V$OS_EVENT_TYPE_MUTEX
                   :: Vint32 i :: Vint32 x :: Vptr (v'52, $ 0) :: x3 :: v'46 :: Vint32 pegrp :: petbl_addr :: nil, v'44, petbl)
...
Proof.
  ...
  eexists;split;eauto.
  splits.
  3:do 3 eexists;splits;eauto. (* change 2: -> 3: *)
  unfolds in H1.
  mytac.
  unfolds.
  splits;auto.
...
: forall tls tid pip st m st' m' p,
       R_Prio_No_Dup tls ->
       TcbMod.get tls tid = Some (pip, st, m) ->
       Int.eq pip p = false ->
...
assert (Htd: tid = t \/ tid <> t) by tauto.
destruct Htd. subst.
rewrite TcbMod.beq_refl in H2.
inverts H2.
auto.
lets Hf: tidspec.neq_beq_false H3.
rewrite Hf in H2.
eapply Int.eq_false.
eapply H; eauto.
Qed.

Lemma RH_TCBList_ECBList_P_post_changeprio':
  forall tid tcbls ecbls pcur xm eid pip prio wl,
    R_Prio_No_Dup tcbls ->
    EcbMod.get ecbls eid = Some (absmutexsem pip (Some(tid, prio)), wl) ->
    TcbMod.get tcbls tid = Some (pip, rdy, xm)->
    (forall eid' p' ow wls', 
              EcbMod.get ecbls eid' = Some (absmutexsem p' ow, wls') ->
              Int.ltu pip p' = true ->
              Int.eq p' prio = false) ->
    Int.ltu pip prio = true ->
    RH_TCBList_ECBList_P ecbls tcbls pcur ->
    RH_TCBList_ECBList_P ecbls (TcbMod.set tcbls tid (prio,rdy,xm)) pcur.
Proof.
  introv Hidm He Ht Hpr Hneq Hrh.
  unfolds in Hrh.
  ...
  rewrite TcbMod.set_sem in H.
  rewrite tidspec.neq_beq_false  in H; auto.
  destruct Hrh4 as (_ & Hrh4 & _ & _). (* new add *)
  eapply Hrh4 in H.
  eauto.
  ...
  destruct Hrh4.
  destruct H0.
  destruct H1 as (H1 & _). (* new add *)
  unfolds in H1.
  intros.
  apply H1 in H2.
  destruct H2 as (H2 & Hin). (* new add *)
  split; auto. (* new add*)
  assert (tid = tid0 \/ tid <> tid0) by tauto.
  destruct H3.
  subst.
  ...
  destruct Hrh4 as (_ & _ & How & Hrh4).
  destruct Hrh4 as (Hnone & Hsome (* & Hop *) & Hdup).
   unfolds.
   splits; intros.
   assert (Hlt: Int.ltu pip pip0 = true \/ Int.ltu pip pip0 = false) by (clear -H; int auto).
   destruct Hlt.
   eapply prio_available_hold_gen; eauto.
   eapply prio_available_hold_gen; eauto.
   rewrite Int.eq_sym.
   eapply ltu_eq_false.
   clear -Hneq H0.
   ...
   assert (Htd: tid = tid0 \/ tid <> tid0) by tauto.
  destruct Htd. subst.
  rewrite TcbMod.beq_refl in H0.
  inverts H0.
   assert (Hp2: pip = pip0 \/ pip <> pip0) by tauto.
  destruct Hp2. subst.
  eapply prio_available_hold_gen'; try eapply Int.eq_false; eauto.
  eapply prio_available_hold_gen; try eapply Int.eq_false; eauto.
  lets Hf: tidspec.neq_beq_false H3.
  rewrite Hf in H0.
   assert (Hlt: Int.ltu pip pip0 = true \/ Int.ltu pip pip0 = false) by (clear -H; int auto).
...
Lemma RH_TCBList_ECBList_P_pend_changeprio:
  forall tid tcbls ecbls pcur xm eid pip prio wl,
    R_Prio_No_Dup tcbls ->
    EcbMod.get ecbls eid = Some (absmutexsem pip (Some(tid, prio)), wl) ->
    TcbMod.get tcbls tid = Some (prio, rdy, xm)->
    RH_TCBList_ECBList_P ecbls tcbls pcur ->
    RH_TCBList_ECBList_P ecbls (TcbMod.set tcbls tid (pip,rdy,xm)) pcur.
Proof.
  introv Hidm He Ht (* Hpr *) (* Hneq *) Hrh.
  unfolds in Hrh.
  destruct Hrh as (Hrh1 & Hrh2 & Hrh3 & Hrh4).
  ...
  destruct Hrh4 as (Hnone & Hsome (* & Hop  *)& Hdup).
   unfolds.
   splits; intros.
  assert (Hed: eid = eid0 \/ eid <> eid0) by tauto.
  destruct Hed. subst.
  unfold get in H. unfold EcbMap in H.
  ...
  rewrite TcbMod.beq_refl in H0.
  inverts H0.
  assert (Hp2: prio = pip0 \/ prio <> pip0) by tauto.
  destruct Hp2. subst.
  eapply prio_available_hold_gen'; try eapply Int.eq_false; eauto.
  eapply prio_available_hold_gen; try eapply Int.eq_false; eauto.
  lets Hf: tidspec.neq_beq_false H3.
  rewrite Hf in H0.
  assert (Hed: eid0 = eid \/ eid0 <> eid) by tauto.
  destruct Hed. subst.
  unfold get in H. unfold EcbMap in H.
  rewrite He in H. inverts H.
  tryfalse.
...
Lemma return_rh_tcbl_ecbl_p : forall v'38 v'39 v'52 v'55 m x10 v'45 v'43 eid wl,
  R_Prio_No_Dup v'39 ->
  EcbMod.get v'38 eid = Some (absmutexsem (v'55>>ᵢ$ 8) (Some((v'52, Int.zero), v'55&ᵢ$ OS_MUTEX_KEEP_LOWER_8)), wl) ->
  (forall (eid' : tidspec.A) (p' : int32) (ow : owner) (wls' : waitset),
          EcbMod.get v'38 eid' = Some (absmutexsem p' ow, wls') ->
          Int.eq p' (v'55&ᵢ$ OS_MUTEX_KEEP_LOWER_8) = false) ->
TcbJoin (v'52, Int.zero) (v'55>>ᵢ$ 8, rdy, m) x10 v'45 ->
  TcbMod.join v'43 v'45 v'39 ->
  RH_TCBList_ECBList_P v'38 v'39 (v'52, Int.zero) ->
...
Proof.
  intros.
  eapply RH_TCBList_ECBList_P_post_changeprio;eauto.
  eapply TcbMod.join_get_r;eauto.
  eapply tcbjoin_get_a;eauto.
Qed.
...
Lemma ecblistp_hold :
  forall v'42 v'25 i x v'52 x3 v'46 v'44 v'26 v'27 v'28 v'38 v'39 v'29 v'48 v'49 v'47 petbl pegrp petbl_addr,
    ...
    ECBList_P v'42 Vnull
              (v'25 ++
                    ((V$OS_EVENT_TYPE_MUTEX
                       ...
                       :: Vnull :: x3 :: v'46 :: Vint32 pegrp :: petbl_addr :: nil, v'44,petbl) :: nil) ++ v'26)
              (v'27 ++
...
(*  intro; tryfalse. *)
  ...
  assert ((absmutexsem i0 o, w) = (absmutexsem (x>>ᵢ$ 8) (Some (v'52, $ 0, x&ᵢ$ OS_MUTEX_KEEP_LOWER_8)),
                                   nil)).
  apply ecbmod_joinsig_get in H7.
  eapply EcbMod.join_get_r in H7;eauto.
  rewrite Hget in H7;inverts H7;auto.
  inverts H0.
...
Lemma  RH_TCBList_ECBList_MUTEX_OWNER_P_set_true:
  forall tcbls pr eid ecbls wls wls' tid op st m,
    TcbMod.get tcbls tid = Some (op, st,m) ->
    EcbMod.get ecbls eid = Some (absmutexsem pr None, wls) ->  
    RH_TCBList_ECBList_MUTEX_OWNER_P ecbls tcbls ->
    RH_TCBList_ECBList_MUTEX_OWNER_P (EcbMod.set ecbls eid (absmutexsem pr (Some (tid, op)), wls')) tcbls.
Proof.
  intros.
  funfold H1.
  unfolds.
  unfold get in *. unfold EcbMap,TcbMap in *. 
  splits; intros;
  ...
  eapply H1; eauto.
  eapply H2; eauto.
  destruct (tidspec.beq eid eid2) eqn: eq1.
  eapply tidspec.beq_true_eq in eq1; subst.
  inverts H5.
  destruct (tidspec.beq eid2 eid1) eqn: eq2.
  eapply tidspec.beq_true_eq in eq2; subst.
  tryfalse.
  eapply H3; eauto.
  destruct (tidspec.beq eid eid1) eqn: eq2.
  eapply tidspec.beq_true_eq in eq2; subst.
  inverts H8.
  eapply H3; eauto.
  eapply H3; eauto.
...
Proof.
  ...
  assert ( eid = v \/ eid <> v)  as aa by tauto.
  destruct aa.
  subst; rewrite EcbMod.set_a_get_a in H4.
  ...
  rewrite EcbMod.set_a_get_a'.
  rewrite H4; repeat eexists; eauto.
   apply tidspec.neq_beq_false;auto.
  ...
  assert (eid = v \/ eid <> v) as aa by tauto; destruct aa; [subst eid; rewrite EcbMod.set_a_get_a in H4 (* change H3 -> H4 *)
                                                            |idtac].
  elim H4; intros. (* change H3 -> H4 *)

  inversion H5. (* change H4 -> H5 *)
  subst.
  eapply H0.
  splits; eauto.
  apply CltEnvMod.beq_refl.
  eapply H0.
  rewrite EcbMod.set_a_get_a' in H4. (* change H3 -> H4 *)
  eauto.
  apply tidspec.neq_beq_false; auto.
  ...
  rewrite EcbMod.set_a_get_a.
  repeat eexists.
  lets aaa : H1 H4. (* change H3 -> H4 *)
  mytac; auto.
  rewrite H in H5. (* change H4 -> H5 *)
  inversion H5. (* change H4 -> H5 *)
  subst.
  auto.
  apply CltEnvMod.beq_refl.
  ...
  (* new about RH_TCBList_ECBList_MUTEX_OWNER_P *)
   eapply RH_TCBList_ECBList_MUTEX_OWNER_P_set_true; eauto.
Qed.
...
Lemma mutex_pend_inv_update1:
  forall i2 i6 s low med high P low' med' high' i0 x3 v'48 x1 x2 x0 v'54 v'41 pegrp petbl_addr,
    s |= AEventData low med ** P ->
    RLH_ECBData_P med high ->
    low = (V$OS_EVENT_TYPE_MUTEX
            :: Vint32 i0 :: Vint32 i2 :: x2 :: x3 :: v'48 :: Vint32 pegrp :: petbl_addr :: nil) ->
    ...
    low' = (V$OS_EVENT_TYPE_MUTEX
             ...
             :: Vptr (v'54, Int.zero) :: x3 :: v'48 :: Vint32 pegrp :: petbl_addr :: nil) ->
...
Lemma ECBList_Mutex_Create_prop :
  forall v'41 v'50 v'22 v'28 v'40
         v'37 v'38 v'27 x i petbl pegrp petbl_addr,
                 ...
                 (or
                    (val_inj
                       (if Int.ltu ($ 8) Int.iwordsize
                        ...
                        else None)) (V$OS_MUTEX_AVAILABLE)) :: x :: v'50 :: v'22 :: Vint32 pegrp :: petbl_addr :: nil, INIT_EVENT_TBL, petbl) :: v'28)
              (DMutex  (val_inj
                          (or
                             (val_inj
                                (if Int.ltu ($ 8) Int.iwordsize
...
Proof.
  ...
  destruct Hac as (Hpostq1 & Hac & Hpostq2). (* new add *)
  lets Hre : Hac H.
  destruct Hre as (xx & yy & pqwaitset & wt & Hec & Hin). (* add pqwaitset *)
  unfold get in *; simpl in *.
  tryfalse.
  unfolds.
  intros.
...
Lemma RH_TCBList_ECBList_MUTEX_OWNER_P_create_true
: forall els tls eid pip wl,
  ~ (exists eid ow wl, EcbMod.get els eid = Some (absmutexsem pip ow, wl)) ->
  ~ (exists tid st msg, TcbMod.get tls tid = Some (pip, st, msg)) ->
  EcbMod.get els eid = None ->
  RH_TCBList_ECBList_MUTEX_OWNER els tls ->
  RH_TCBList_ECBList_MUTEX_OWNER_P els tls ->
  RH_TCBList_ECBList_MUTEX_OWNER_P (EcbMod.set els eid (absmutexsem pip None,wl)) tls.
Proof.
introv Hidm Hnp He How Hrh.
funfold Hrh.
unfolds.
splits; intros;
try rewrite EcbMod.set_sem in *;
...
unfolds; intros.
eapply Int.eq_false.
assert (Hp: pip0 = p \/ pip0 <> p) by tauto.
destruct Hp; auto. subst.
destruct Hnp. eauto.
eapply H; eauto.
eapply H0; eauto.
destruct (tidspec.beq eid eid2) eqn: eq1.
...
eapply tidspec.beq_true_eq in eq2; subst.
tryfalse.
assert (Hp: pip1 = pip2 \/ pip1 <> pip2) by tauto.
destruct Hp; auto. subst.
false. eapply Hidm. eauto.
destruct (tidspec.beq eid eid1) eqn: eq2.
eapply tidspec.beq_true_eq in eq2; subst.
inverts H6.
assert (Hp: pip1 = pip2 \/ pip1 <> pip2) by tauto.
...
Lemma Mutex_Create_TCB_prop :
  forall v'37  x  i v'38 v'40,
   ~ (exists eid ow wl, EcbMod.get v'37 eid = Some (absmutexsem i ow, wl)) ->
    ...
    RH_TCBList_ECBList_P
      ...
      v'38 v'40.
Proof.
  introv HHHHH Hnew. (* new add Hnew *)
  intros.
  unfolds.
  unfolds in H0.
  ...
  destruct Ha1.
  destruct H1 as (Hpostq1 & H1 & Hpostq2). (* new add *)
  unfolds.
  splits.
  intros.
  ...
  mytac.
  do 3 eexists; splits; eauto.
  destruct H1 as (H1 & How & Howp). (* new add *)
  split. (* new add *)
  apply Mutex_owner_set'; auto.
(*   destruct H1 as (H1 & How & Howp); auto. *)
  eapply RH_TCBList_ECBList_MUTEX_OWNER_P_create_true; eauto. (* new add *)
...
Lemma  ecb_wt_ex_prop_mutex :
  forall
    ...
    v'23 v'35 i i3 x2 x3 v'42 v'40 petbl pegrp petbl_addr,
    Int.eq i ($ 0) = false ->
    Int.unsigned i <= 255 ->
    ...
    R_ECB_ETbl_P x
                 (V$OS_EVENT_TYPE_MUTEX
                   :: Vint32 i
                   :: Vint32 i3 :: x2 :: x3 :: v'42 :: Vint32 pegrp :: petbl_addr :: nil,
                  v'40, petbl) v'35 ->
...
Lemma ecblist_ecbmod_get_aux_mutex :
  forall v'61 i6  x4 x8 v'58 v'42  
         v'63 x20 v'37 v'35 v'36 v'38 x21 petbl pegrp petbl_addr,
    ...
    ECBList_P (Vptr (v'61, Int.zero)) Vnull
              (
                ((V$OS_EVENT_TYPE_MUTEX
                   :: V$0 :: Vint32 i6 :: v'63 :: x4 :: x8 :: Vint32 pegrp :: petbl_addr :: nil,
                  v'58, petbl) :: nil) ++ v'42)
...
Proof.
  ...
  auto.
  simpl in Hep.
  destruct Hep as (qid & Heq & Heb & Hpb & Hex). (* add Hpb *)
...
Lemma ecblist_ecbmod_get_mutex :
  forall v'61 i6  x4 x8 v'58 v'42 v'21 v'63 x20 v'37 v'35 v'36 v'38 x21 petbl pegrp petbl_addr,
    length v'21 = O  ->
    array_type_vallist_match Int8u v'58->
    RH_CurTCB v'38 v'36 ->
    length v'58 = ∘OS_EVENT_TBL_SIZE ->
...
Lemma ecblist_ecbmod_get_mutex' :
  forall v'40 v'52 v'61 i6  x4 x8 v'58 v'42 v'21 xx
         v'63 x20 i5 v'37 v'35 v'36 v'38 x21 petbl pegrp petbl_addr,
    ...
    ECBList_P v'52 Vnull
              (v'40 ++
                    ((V$OS_EVENT_TYPE_MUTEX
                       :: xx :: Vint32 i6 :: v'63 :: x4 :: x8 :: Vint32 pegrp :: petbl_addr :: nil,
                      v'58, petbl) :: nil) ++ v'42)
              (v'21 ++
                    (DMutex x20 x21 :: nil) ++ v'37) v'35 v'36 ->
...
Proof.
  ...
  destruct H15.
  destruct H16.
  destruct H17 as (H17 & Howp). (* new add *)
  unfolds in H17.
  unfolds in H2.
  mytac.
  lets fff: H2 H9 H10.
...
Lemma  RH_TCBList_ECBList_MUTEX_OWNER_P_set_true':
  forall tcbls pr eid ecbls wls wls' tid op st m,
    ...
    pr <> op ->
    TcbMod.get tcbls tid = Some (op, st,m) ->
    EcbMod.get ecbls eid = Some (absmutexsem pr (Some (tid, op)), wls) -> 
    RH_TCBList_ECBList_MUTEX_OWNER_P ecbls tcbls ->
    RH_TCBList_ECBList_MUTEX_OWNER_P (EcbMod.set ecbls eid (absmutexsem pr None, wls')) tcbls.
Proof.
  introv Hin. intros.
  funfold H2.
  unfolds.
...
Lemma mutex_rh_tcblist_ecblist_p_hold:
 forall v'34 v'35 v'37 v w tid m op st msg,
 m <> op ->
 TcbMod.get v'35 tid = Some (op, st, msg) ->
 EcbMod.get v'34 v = Some (absmutexsem m (Some (tid, op)), w) ->
 RH_TCBList_ECBList_P v'34 v'35 v'37 ->
 RH_TCBList_ECBList_P
                   (EcbMod.set v'34 v (absmutexsem m None, w)) v'35 v'37.
Proof.
  introv Hnp Ht. (* new add *)
  intros.
  unfolds in H0.
  mytac.
  unfolds.
  mytac;
 [clear -Hnp Ht H H0|
   clear -Hnp Ht H H1; rename H1 into H0|
  clear -Hnp Ht H H2; rename H2 into H0| 
  clear -Hnp Ht H H3; rename H3 into H0];
 unfolds; unfolds in H0; mytac; intros; unfold get in *; simpl in *;
  try solve [eapply H0;
              mytac; eauto;
  ...
  rewrite EcbMod.set_a_get_a in H4. (* change H3 -> H4 *)
  mytac.
  inverts H4. (* change H3 -> H4 *)
  eapply H0.
  mytac; eauto.
  go.
  rewrite EcbMod.set_a_get_a' in H4. (* change H3 -> H4 *)
  lets fff: H0 H4. (* change H3 -> H4 *)
  auto.
  go.

  assert (eid = v \/ eid <> v) as aa by tauto; destruct aa.
  subst eid.
  lets fff: H1 H4. (* change H3 -> H4 *)
  mytac.
  rewrite EcbMod.set_a_get_a.
  repeat tri_exists_and_solver1.
  rewrite H in H5. (* change H4 -> H5 *)
  inverts H5. (* change H4 -> H5 *)
  auto.
  go.
  rewrite EcbMod.set_a_get_a'.
  eapply H1; eauto.
