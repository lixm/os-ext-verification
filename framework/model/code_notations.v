...
Notation "'IF' ( E ) { S1 } 'ELSE' { S2 }" := (sif E S1 S2) (at level 90,right associativity) : code_scope.
Notation "'If' ( E ) { S }" := (sifthen E S) (at level 90) : code_scope.
Notation "'WHILE' ( E ) { S }" := (swhile E S) (at level 90)  : code_scope.
...
Notation "'⌞' I1 @ T1 ';'  I2 @ T2  ';'  I3 @ T3 ';' I4 @ T4 ';'  I5 @ T5 ';'  I6 @ T6 ';' I7 @ T7 ';' I8 @ T8 ';' I9 @ T9 ';' I10 @ T10 ';' I11 @ T11 ';' I12 @ T12 ';' I13 @ T13 '⌟' " := (dcons I1 T1 (dcons I2 T2 (dcons I3 T3 (dcons I4 T4 (dcons I5 T5 (dcons I6 T6 (dcons I7 T7 (dcons I8 T8 (dcons I9 T9 (dcons I10 T10 (dcons I11 T11 (dcons I12 T12 (dcons I13 T13 dnil))))))))))))) 
    (at level 5, right associativity) : code_scope .

Notation "'⌞' I1 @ T1 ';'  I2 @ T2  ';'  I3 @ T3 ';' I4 @ T4 ';'  I5 @ T5 ';'  I6 @ T6 ';' I7 @ T7 ';' I8 @ T8 ';' I9 @ T9 ';' I10 @ T10 ';' I11 @ T11 ';' I12 @ T12 ';' I13 @ T13 ';' I14 @ T14 '⌟' " := (dcons I1 T1 (dcons I2 T2 (dcons I3 T3 (dcons I4 T4 (dcons I5 T5 (dcons I6 T6 (dcons I7 T7 (dcons I8 T8 (dcons I9 T9 (dcons I10 T10 (dcons I11 T11 (dcons I12 T12 (dcons I13 T13 (dcons I14 T14 dnil)))))))))))))) 
    (at level 5, right associativity) : code_scope .

Notation "'⌞' I1 @ T1 ';'  I2 @ T2  ';'  I3 @ T3 ';' I4 @ T4 ';'  I5 @ T5 ';'  I6 @ T6 ';' I7 @ T7 ';' I8 @ T8 ';' I9 @ T9 ';' I10 @ T10 ';' I11 @ T11 ';' I12 @ T12 ';' I13 @ T13 ';' I14 @ T14 ';' I15 @ T15 '⌟' " := (dcons I1 T1 (dcons I2 T2 (dcons I3 T3 (dcons I4 T4 (dcons I5 T5 (dcons I6 T6 (dcons I7 T7 (dcons I8 T8 (dcons I9 T9 (dcons I10 T10 (dcons I11 T11 (dcons I12 T12 (dcons I13 T13 (dcons I14 T14 (dcons I15 T15 dnil))))))))))))))) 
    (at level 5, right associativity) : code_scope .

Notation "'⌞' I1 @ T1 ';'  I2 @ T2  ';'  I3 @ T3 ';' I4 @ T4 ';'  I5 @ T5 ';'  I6 @ T6 ';' I7 @ T7 ';' I8 @ T8 ';' I9 @ T9 ';' I10 @ T10 ';' I11 @ T11 ';' I12 @ T12 ';' I13 @ T13 ';' I14 @ T14 ';' I15 @ T15 ';' I16 @ T16 '⌟' " := (dcons I1 T1 (dcons I2 T2 (dcons I3 T3 (dcons I4 T4 (dcons I5 T5 (dcons I6 T6 (dcons I7 T7 (dcons I8 T8 (dcons I9 T9 (dcons I10 T10 (dcons I11 T11 (dcons I12 T12 (dcons I13 T13 (dcons I14 T14 (dcons I15 T15 (dcons I16 T16 dnil)))))))))))))))) 
    (at level 5, right associativity) : code_scope .
...
(*add /modify*)
(********************************************************************************)
Notation "'unsigned_int'" := (Tint32) (at level 5) : code_scope .
Notation "'char'" := (Tint8) (at level 5) : code_scope .
Notation "'Int8s'" := (Tint8) (at level 5) : code_scope .
Notation "'Int32s'" := (Tint32) (at level 5) : code_scope .
Notation "'dom_t'" := (Tint32) (at level 5) : code_scope .
Notation "'Long'" := (Tint32) (at level 5) : code_scope.
Notation "'size_t'" := (Tint32) (at level 5) : code_scope.
Notation "'unsigned'" := (Tint32) (at level 5) : code_scope.
Notation "'ssize_t'" := (Tint32) (at level 5) : code_scope .
Notation "'unsigned_t'" := (Tint32) (at level 5) : code_scope .
Notation "'char_t'" := (Tint8) (at level 5) : code_scope .
Notation "'long'" := (Tint32) (at level 5) : code_scope .
