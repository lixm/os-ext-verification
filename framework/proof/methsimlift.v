...
Proof.
  ...
  lets Hre0 : Hre0' Hnabt. clear Hre0'.
  simp join.
  ...
  introv _ Hinv Hjm1 Hdisj Hjoin Hnabt.
  ...
  lets Hre0 : H0 Hdisj Hnabt; eauto.
  ...
  introv Hinv Hjm1 Hdisj Hjoin Hnabt Hstep.
  destruct o as [[[[G E]MM ]isr] aux].
  unfold joinm2 in Hjm1.
  unfold joinmem in Hjm1.
  simp join.
  ...
  lets HOOeq: (join_lib.join_unique Hdisj Hjoin). rewrite HOOeq in *. clear OO0 HOOeq.
  (* lets Hresk : H0   Hinv Hdisj; eauto.   *)
  lets Hresk : H0 Hinv Hdisj Hnabt; eauto.  
  unfolds; eauto.
  ...
  lets Hre0 : H1 Hmdisj Hinv Hdisj Hnabt; eauto. 
  simp join.
  ...
  introv Hsat1 Hdisjj Hijo Hnabt. 
  (* lets Hks : H7 Hsat1 Hdisjj Hijo; eauto. *)
  lets Hks : H7 Hsat1 Hdisjj Hijo Hnabt; eauto. 
  simp join.
  ...
  lets Hks : H8 Hsat1 Hdisjj Hijo Hnabt; eauto. 
  simp join.
  destruct H12.
  simp join.
