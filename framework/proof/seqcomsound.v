...
Proof.
  ...
  constructors. (* or apply meth_sim_mod. *) 
...
eapply intcont_none_addstmts; eauto.
  ...
  introv Hnot  Hjm1 Hjm2 Hinv Hdisj Hnabt.
  ...
  introv Hnabt. (* lxm *)
  (* lets Hres : H0 Hmdisj Hinv Hdisj. *)
  ...
  lets Hres : H1 Hmdisj Hinv Hnabt; eauto.
  simp join.
  ...
  lets Hres : H2 Hinv Hjm2 Hnabt; eauto.
  clear -Hjm1.
  unfolds.
  unfolds in Hjm1.
  ...
  introv Hcall Hintt Hmdisj Hinv Hdisj Hnabt.
  rewrite  addstmts_eq_addcont  in *. 
  (* lets Hres : H3 Hcal Hint Hmdisj Hinv Hdisj. *)
  lets Hres0 : H3 Hcal Hint Hmdisj Hinv Hdisj. 
  eauto.
...
lets Hres : H7 Hcal Hint ; eauto.
  ...
  (* eauto.  *)
  lets Hres0 : H5 Hcal Hint Hmdisj Hinv Hdisj. eauto.
  lets Hres : Hres0 Hnabt. clear Hres0.
  simp join.
  do 4 eexists; splits; eauto. 
