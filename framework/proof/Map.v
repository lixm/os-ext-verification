...
Proof.
  ...
  destruct (b0 (refl_equal _)).
Qed.
Arguments mapsto_put_eq [m a b b'].
...
Qed.
Arguments mapsto_put_neq [m a a' b b'].
...
destruct (H0 (refl_equal _)).
Qed.
Arguments mapsto_mapsto_put [m a b a'].
...
Qed.
Arguments mapsto_subseteq_mapsto [m m' a b].
