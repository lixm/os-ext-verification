...
Proof.
  ...
  introv Hjm1 Hjm2 Hinv Hjo Hnabt Hf.
  apply Hf.
  unfolds in Hjm2.
...
Proof.
  ...
  introv Hinv Hdisj Hmdijs Hnabt.
  apply Hx in Hsat.
  simpl in Hsat.
  destruct Hsat as (M1&M2&M0&o1&o2&oo&Heq1&Hmj1&Heq2&Haj&Hppre & Hpp).
  subst.
  ...
  inverts Hfa.
  (* introv Hivnv1 Hdisj1 Hjj1. *)
  introv Hivnv1 Hdisj1 Hjj1 Hnabt''.  
  exists gamma''  OO0 O'' Os0.
  splits; eauto.
  constructors.
...
Proof.
  ...
  introv Hinvs Hjm11 Hjm22 Hstep Hnabt'. 
  invertstep idtac.
  destruct o' as [[[[]]]].
  unfolds in Henv.
  simp join.
  ...
  introv Hiinn Hjjm1 Hjjm2 Hstepp Hnabt''. 
  invertstep idtac.
  ...
  introv Hmaaj Hivvv Hdssss Hnabt4. 
  ...
  introv Hdj1 Hdinv Hddsij Hjoin' Hnabt5 Hss. 
  apply Hss.
  destruct o2 as [[[[]]]].
  unfolds in Hdinv.
  ...
  constructors; introv Hfa; tryfalse.
  (* introv Hinvs Hjm11 Hjm22 Hstep. *)
  introv Hinvs Hjm11 Hjm22 Hstep Hnabt6. 
  invertstep idtac.
  destruct o' as [[[[]]]].
  unfolds in Henv.
  simp join.
  ...
  constructors; introv Hfff; tryfalse.
  (* introv Hiinn Hjjm1 Hjjm2 Hstepp. *)
  introv Hiinn Hjjm1 Hjjm2 Hstepp Hnabt7. 
  invertstep idtac.
  ...
  simpl substaskst in *.
  (* introv Hmaaj Hivvv Hdssss. *)
  introv Hmaaj Hivvv Hdssss Hnabt9. 
  exists gamma'' OO2  O'' Os2.
  splits; eauto.
  constructors.
  assert ((x7, x10, x13, x18, x19, O1, gamma'') |= EX v1, POST  [post, rev (rev vl0 ++ v :: nil),  v1, logicl, t]).
  ...
  eexists; eauto.
  (* introv Hdj1   Hdinv Hddsij Hss. *)
  introv Hdj1   Hdinv Hddsij Hjoin'' Hnabt10 Hss. 
  apply Hss.
  destruct o2 as [[[[]]]].
  unfolds in Hdinv.
  unfold joinmem in Hdinv.
