...
Definition InitTaskSt lasrt t (s:reltaskst) :Prop :=
  satp (fst s) (snd s) (CurTid t ** LINV lasrt t init_lg ** OS [empisr,true,nil,nil]) /\ emptaskenv (fst s)
(*/\ fst (fst (fst (fst (fst s))))= InitG*).
