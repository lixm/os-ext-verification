...
Proof.
  ...
  introv Hinv  Hjm2 Hdisj  Hstep Hnabt. 
  invertstep idtac.
  ...
  assert (Hnex: ~(exists OO', hmstepstar sd gamma O (ABORT) OO')). 
  {
    introv Hex. apply Hnabt. 
    destruct Hex as (OO' & Hstpstar).    
    lets Hstpstr: spec_stepstar_locality Hstpstar.
    apply Hstpstr in Hjo2.
    destruct Hjo2 as (O2 & Hhmstpstr & _).
    exists O2; auto.
  }
  (* lets Hsre : H Hfcall'  Hinv'  Hj1 Hjo1 Hstp;  eauto.  *)
  lets Hsre0 : H Hfcall'  Hinv'  Hj1 Hjo1 Hstp;  eauto.
  lets Hsre : Hsre0 Hnex. clear Hsre0. 
  destruct Hsre as (gam & OO' &  oo & Mss & Ol & Oss  &Hsttar & Hjmm2 & Hjjj  & Hinvv & Hlinv  & Hsim).  

  inverts Hsim.
  assert (Hnex': ~ (exists OO'0, hmstepstar sd gam OO' (ABORT) OO'0)).
  {
    introv Hex. apply Hnex.
    destruct Hex as (OO'0 & Hstpstr).
    lets Hcomp: hmstepstar_trans Hsttar Hstpstr.
    eexists; eauto.
  }
  (* lets Has : H13 Hinvv Hjjj; eauto. *)
  lets Has : H13 Hinvv Hjjj Hnex'; eauto. 
  ...
  lets Hnotb00 : H6 p Htrue Hinv' Hj1 Hdisj.
  lets Hnotb0 : Hnotb00 Hjo1. clear Hnotb00.
  assert (Hnex': ~ (exists OO', hmstepstar sd gamma O (ABORT) OO')).
  {
    introv Hex. apply Hnabt. 
    destruct Hex as (OO' & Hstpstar).    
  ...
  lets Hnotb : Hnotb0 Hnex'. clear Hnotb0.
  ...
  lets Hres0 : H p Hfcall' Hinv' Hj1  Hstpp; eauto.
  lets Hres : Hres0 Hnex'. clear Hres0.
  ...
  introv Hn Hinv  Hjm1  Hdisj Hjoin Hnabt. 
  lets Hres :  join_frame_dis Hjm1 Hjm.
  destruct Hres as (MM & Hj1 & Hj2 ).
  lets Hinv' :  joinmem_satp_mono Hinv; eauto.
  (*
  ...
  lets Hnotb00 : H6 p Htrue Hinv' Hj1 Hat.  
  lets HjoO1Os: (join_lib.join_merge_disj Hat).
  lets Hnotb0: Hnotb00 HjoO1Os. clear Hnotb00.
  assert (Hnex: ~ (exists OO', hmstepstar sd gamma (merge O1 Os) (ABORT) OO') ).
  {
    introv Hex. apply Hnabt.
    destruct Hex as (OO' & Hstpstr).
    exists (merge Of OO').
    lets Hloc: spec_stepstar_locality Hstpstr OO.
    lets Hjos': (join_lib.join_comm Hjos).
    lets Hjo: (join_lib.join_merge23' Hjos' Hjoin).
    lets Hex: Hloc Hjo. destruct Hex as (O2 & HstpstrOO & HjoOO').
    lets HO2: (join_merge HjoOO').
    rewrite <- HO2; auto.
  }
  lets Hnotb : Hnotb0 Hnex. clear Hnotb0. clear HjoO1Os.
  ...
  lets Hres : H0 Hinv' Hjo1 Hnex'; eauto. 
  ...
  lets Hres : H1  Hinv' Hjo1 Hnex'; eauto. 
  ...
  lets Hres : H7  Hinv' Hjo1 Hnex'; eauto.  
  destruct Hres as
  ...
  lets Hres : H8 Hinv' Hjo1 Hnex'; eauto.  
  destruct Hres as
...
Proof.
  ...
  introv Hinv Hjm  Hjoin  Hstep Hnabt. 
  invertstep idtac.
  ...
  introv   Hinvv   Hdisjj Hjon Hnabt'. 
...
Proof.
  ...
  lets Hnota0 : H6 p Htrue Hjm1 Hdisj Hjm2; eauto.
  lets Hnota : Hnota0 Hnabt. clear Hnota0.
  ...
  lets Hres0 : H Hfcal' Hinv Hjm1 Hjm2 Hlstep.
  lets Hres : Hres0 Hnabt. clear Hres0.
  simp join.
  ...
  introv Hnot  Hinv Hjm1  Hdisj Hjoin Hnabt. 
  (* lets Hnotb : H6 p Htrue Hjm1 Hdisj; eauto.   *)
  lets Hnotb0 : H6 p Htrue Hjm1 Hdisj Hjoin; eauto.   
  lets Hnotb : Hnotb0 Hnabt. clear Hnotb0.
  eapply  loststepabt_cont_loststepabt'; eauto.
  ...
  lets Hres : H0  Hinv Hdisj Hjoin Hnabt; eauto. 
  simp join.
  ...
  lets Hres : H1  Hinv Hdisj Hjoin Hnabt; eauto. 
  simp join.
  ...
  introv  Hinv Hjm1 Hdisj Hjoin Hnabt. 
  inverts Hsim.
  unfold disjoint in Hdisj.
  destruct Hdisj as (z & Hdisj).

  assert (HzOO: z = OO).
  { lets H00: (join_lib.join_unique Hdisj Hjoin); exact H00. }
  rewrite HzOO in *. clear HzOO.
  (* lets Hfal : H2  Hdisj; eauto. *)
  lets Hfal : H2 Hdisj Hnabt; eauto.
  ...
  lets Hes : H3 Hcal Hint Hinv Hjm2 Hnabt; eauto. 
  unfold joinm2 in Hjm1.
  unfold joinmem in *.
  simp join.
  unfolds.
  ...
  lets Hes : H5 Hcal Hint Hinv Hjm2 Hnabt; eauto. 
  unfold joinm2 in Hjm1.
  unfold joinmem in *.
  simp join.
  unfolds.
  ...
  introv  Hinv Hjm1 Hjm2 Hjoin Hnabt. 
  inverts Hsim.
  ...
  assert (HeqO: OO = Ok). 
  { lets H00: (join_lib.join_unique Hjoin Hk). exact H00. }
  rewrite <- HeqO in *.  clear HeqO.
  (* lets Hres : H5 Hcal Hint Hinv Hk; eauto. *)
  lets Hres : H5 Hcal Hint Hinv Hk Hnabt; eauto. 
  unfold joinm2 in Hjm1.
  unfold joinmem in *.
  simp join.
  unfolds.
  ...
  lets Hres : H7  Hinv Hdisj Hjoin Hnabt; eauto. 
  simp join.
  ...
  lets Hres : H8  Hinv Hdisj Hjoin Hnabt; eauto. 
  simp join.
