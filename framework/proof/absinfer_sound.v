...
Proof.
  ...
  (* the following group of tactics is added due to
     the new clause in spec_step saying that if an abs op
     steps to None then the abstract statement steps to ABORT *) 
  exists O1.
  split; auto.
  constructors; eauto.
  join auto.
  ...
  (* added for spec_abort in sequential composition *) 
  exists O1.
  constructors; auto.
  constructors.

  (* added due to changes in semantics *) 
...
Proof.  
 ...
 unfolds; join auto.
  ...
  (* spec_abort in sequential composition *) 
  unfolds.
  introv Hsat.
  exists O spec_abort.
  destruct s0 as [[[[]]]].
  ...
  rewrite <- H3.
  constructors.
  eapply spec_assert_step_cont; eauto.
  rewrite jl_merge_emp.
  join auto.
  constructors.
  do 6 eexists; splits; simp join; eauto.
  ...
  simpl.
  splits; auto.
  assert (merge  O empabst  = O) by apply jl_merge_emp.
  rewrite <- H3.
  constructors.
  eapply spec_assert_step_abt; eauto.
  rewrite jl_merge_emp.
  join auto.
  constructors.
  do 6 eexists; splits; simp join; eauto.
