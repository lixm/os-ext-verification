...
Proof.
  ...
  eapply store_asrt_hold'; try eapply Htma; eauto.
  eapply Hc; eauto.
  lets Hbs : Hlin Hpq.  
  ...
  introv Hinnv Hjmm2 Hddisj Hjoin Hnabt' Hstep.
  apply Hstep.
  ...
  lets Hes : store_exist_join H8 H0 H3 H7.
  destruct Hes.
  do 2 eexists.
  eapply ostc_step.
  eapply stmt_step.
  ...
  constructors; eauto.
  (* introv _ _ _ Habrt. *)
  introv _ _ _ Hjoin Hnabt' Habrt.
  apply Habrt.
