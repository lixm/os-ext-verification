...
Definition match_tid_prio (tls:  TcbMod.map) (v v' : val) := 
  (exists pr a tid, v = Vptr tid /\ get tls tid = Some (pr, a) /\ v' = Vint32 pr).
...
| absabort_rule : forall Spec sd I r ri p q s pa t,
  ...
  | delself_rule : forall pa P  prio st tls' tls t e tp  aop r ri sd Spec I isr ie is cs,
                         GoodLInvAsrt pa ->
                         GoodFrm P ->
 ...
 | delother_rule : forall pa P  prio st tls' tls t e tp t1 aop r ri sd Spec I isr ie is cs,
                         GoodLInvAsrt pa ->
                         GoodFrm P ->
